...
<div id="contact-form">
	<div>
		...
		<p id="success">Your message was sent successfully. Thank you!</p>
		   ...
		   <form method="post" action="device_off.php">
			<div>
   ...
   <button name="submit" type="submit" id="submit" >SWITCH OFF</button> 
...
include('con.php');
$sql = "UPDATE Access SET device_status='OFF' WHERE device_id='$_POST[device_id]'";
